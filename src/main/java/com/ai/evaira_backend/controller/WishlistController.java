...
import com.ai.evaira_backend.service.WishlistService;
...
public class WishlistController {
    ...
    public WishlistController(WishlistService wishlistService, JwtUtil jwtUtil, UserRepository userRepository) {
